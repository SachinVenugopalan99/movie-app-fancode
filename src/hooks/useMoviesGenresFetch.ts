...
export const useMoviesGenresFetch = () => {
  ...
  const fetchData = useCallback(async (emptyList = false) => {
    try {
  ...
  }, [yearOffset, activeTab, data, currentYear]);
  ...
  }, [yearOffset, searchQuery, fetchData, fetchDataOnSearch]);
  ...
  }, [yearOffset, data, searchQuery, currentYear]);
